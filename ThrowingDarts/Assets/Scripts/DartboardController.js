//@input Asset.Material dartboardMaterial
//@input Asset.Texture[] numbersTex
//@ui {"widget":"separator"}
//@input bool debug
//@input string debugName = "Dartboard Controller" {"showIf":"debug"}
...
script.setNumbers = function(idx){
    ...
    script.dartboardMaterial.mainPass.numbersMap = script.numbersTex[idx];
}
